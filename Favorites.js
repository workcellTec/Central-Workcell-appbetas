        ...
        <div style="display:flex;align-items:flex-start;gap:10px;position:relative;">
            ...
            <div style="flex:1;min-width:0;">
                ...
                <button onclick="
                    ...
                    var btn=this;
                    if(el.style.webkitLineClamp==='4'||el.style.webkitLineClamp===''){
                ...
                <div style="display:flex;gap:6px;flex-wrap:wrap;margin-top:${texto.length > 180 ? '4px' : '10px'}">
                    ${actionPrimary ? `
